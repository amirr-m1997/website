$(window).on("load", function () {
    ...
    o(), t.resize(o), $.scrollIt({
        ...
        if ($("section.stats").length > 0) {
            ...
            $(window).on("scroll", function () {
                ...
                0 == t && $(window).scrollTop() > o && ($("section.stats .single-stat .counter").each(function () {
                    var t = $(this), o = t.attr("data-count");
                    $({countNum: t.text()}).animate({countNum: o}, {
    ...
    }), t.stellar({horizontalScrolling: !1}), $(".portfolio .link").magnificPopup({
        delegate: "a",
        type: "image",
        gallery: {enabled: !0}
        ...
        var o = $("#contact-name").val(), a = $("#contact-email").val(), e = $("#contact-message").val(), n = 0;
